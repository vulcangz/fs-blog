...
import TopMain from '@/components/feed/top-main';
import React from 'react';
import { Metadata } from 'next/types';

export const metadata: Metadata = {
  title: 'FS BLOG Community - Top posts this year',
  keywords: 'Top posts this year',
  description: 'Top posts this year'
};
  ...
  return (
    <Fragment>
      <Grid w="full" maxW="7xl" m="auto" templateColumns="240px 3fr 1fr" gap="4">
        ...
        <GridItem>
          <TopMain tabIndex={2} subTabIndex={2} />
        </GridItem>
        <GridItem>
