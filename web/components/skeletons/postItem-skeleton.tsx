...
const PostItemSkeleton = ({ firstItem }: { firstItem?: boolean }) => {
  ...
  return (
    <Box
      ...
      className="shadow"
    >
      {firstItem && <Box h={{ base: '200px', md: '230px' }} mb=".5rem"></Box>}

      <HStack>
        <SkeletonCircle size="10" {...skeletonColor} />
        <SkeletonText mt={3} noOfLines={2} spacing="2" w="30%" {...skeletonColor} />
      </HStack>
      ...
      <Box ms={{ base: '0', md: '48px' }}>
        ...
        <HStack justify="space-between" mt={2}>
          <HStack>
            <HStack>
              <Skeleton w={['50px', '90px']} h="15px" {...skeletonColor} />
            </HStack>
            <HStack>
              <Skeleton w={['50px', '90px']} h="15px" {...skeletonColor} />
            </HStack>
